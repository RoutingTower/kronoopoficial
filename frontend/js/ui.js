...
const NAV = {
  analista:[ {k:'flashcards', label:'Programação', icon:'calendar'}, {k:'recados', label:'Caixa de Entrada', icon:'inbox'}, {k:'spr', label:'SPR', icon:'hash'}, {k:'resultadospr', label:'Resultado SPR', icon:'target'}, {k:'tempoexecucao', label:'Tempo de Execução', icon:'hourglass'}, {k:'formularios', label:'Formulários', icon:'clipboard-list'}, {k:'feedback', label:'Feedback', icon:'star'}, {k:'quiz', label:'Quiz', icon:'gamepad-2'}, {k:'configuracoes', label:'Configurações', icon:'settings'} ],
  supervisor:[ {k:'cadastros', label:'Cadastros', icon:'users'}, {k:'basemestra', label:'Operações Fixas', icon:'map-pin'}, {k:'spr', label:'SPR', icon:'hash'}, {k:'linksseatalk', label:'Links SeaTalk', icon:'message-circle'}, {k:'resultadospr', label:'Resultado SPR', icon:'target'}, {k:'tempoexecucao', label:'Tempo de Execução', icon:'hourglass'}, {k:'suplencias', label:'Cobertura', icon:'repeat'}, {k:'programacao', label:'Programação Analista', icon:'calendar'}, {k:'domingos', label:'Controle de Domingos', icon:'calendar-days'}, {k:'reunioes', label:'Eventos', icon:'handshake'}, {k:'particularidades', label:'Particularidades', icon:'sticky-note'}, {k:'transmissao', label:'Caixa de Envio', icon:'megaphone'}, {k:'ocorrencias', label:'Ocorrências', icon:'flag'}, {k:'feedbacks', label:'Feedbacks', icon:'star'}, {k:'formularios', label:'Formulários', icon:'clipboard-list'}, {k:'quiz', label:'Quiz', icon:'gamepad-2'}, {k:'configuracoes', label:'Configurações', icon:'settings'} ],
