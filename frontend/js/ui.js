...
const NAV = {
  ...
  supervisor:[ {k:'cadastros', label:'Cadastros', icon:'👥'}, {k:'basemestra', label:'Operações Fixas', icon:'📌'}, {k:'spr', label:'SPR', icon:'🔢'}, {k:'resultadospr', label:'Resultado SPR', icon:'🎯'}, {k:'suplencias', label:'Cobertura', icon:'🔁'}, {k:'programacao', label:'Programação Analista', icon:'🗓️'}, {k:'grade', label:'Grade do Dia', icon:'📋'}, {k:'domingos', label:'Controle de Domingos', icon:'📆'}, {k:'reunioes', label:'Eventos', icon:'📅'}, {k:'particularidades', label:'Particularidades', icon:'📝'}, {k:'metricas', label:'Métricas', icon:'📊'}, {k:'transmissao', label:'Caixa de Envio', icon:'📣'}, {k:'ocorrencias', label:'Ocorrências', icon:'🚩'}, {k:'feedbacks', label:'Feedbacks', icon:'⭐'}, {k:'configuracoes', label:'Configurações', icon:'⚙️'} ],
